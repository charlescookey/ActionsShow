 ...
 * @def	DEBUGLINE
 *
 * @brief	A macro that defines debugline
 *
 **************************************************************************************************/
...
#define DEBUGLINE() printf("%s:%d\n", __FILE__, __LINE__);
	...
	/**********************************************************************************************//**
	 * @fn	template<typename T> static T fromString(const std::string* s)
	 *
	 * @brief	Initializes this  from the given string
	 *
	...
	/**********************************************************************************************//**
	 * @fn	template<typename T> static T fromString(const char* s)
	 *
	 * @brief	Initializes this  from the given string
	 *
	 * @tparam	T	Generic type parameter.
	...
	/**********************************************************************************************//**
	 * @fn	static inline bool isdigit(const std::string& s, int i = 0)
	 *
	 * @brief	Query if 's' isdigit
	 *
			 *
	 * @param 	s	A std::string to process.
	 * @param 	i	(Optional) Zero-based index of the.
	 *
	...
	/**********************************************************************************************//**
	 * @fn	static bool isdigit(const std::string* s, int i = 0)
	 *
	 * @brief	Query if 's' isdigit
	 *
			 *
	...
	/**********************************************************************************************//**
	 * @fn	static bool CmpOptStringPtr(std::string* s1, std::string* s2)
	 *
	 * @brief	/* &lt; .
	 * 			 Compare strings for opts, so short opt flags come before long format flags. For
	 * 			 example, -d &lt; --dimension &lt; --dmn, and also lower come before upper. The
	 * 			 default STL std::string compare doesn't do that.
	 *
	 * @param [in,out]	s1	If non-null, the first std::string.
	 * @param [in,out]	s2	If non-null, the second std::string.
	 *
	 * @returns	True if it succeeds, false if it fails.
	 **************************************************************************************************/
	...
	/**********************************************************************************************/
	/*	/**
	 * @fn	static void SplitDelim(const std::string& s, const char token, std::vector<std::string*>* result)
	 *
	 * @brief	Makes a vector of strings from one string, splitting at (and excluding) delimiter
	 * 				"token".
	 *
	 * @param 	   	s	  	The excluding.
	...
	/**********************************************************************************************//**
	 * @fn	static void SplitDelim(const std::string& s, const char token, std::list<std::string*>& result)
	 *
	 * @brief	Splits a delimiter
	 *
	 * @param 	   	s	  	A std::string to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToU1(std::string** strings, unsigned char* out, int n)
	 *
	 * @brief	Converts this  to an u 1
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToS1(std::string** strings, char* out, int n)
	 *
	 * @brief	Converts this  to the s 1
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToU2(std::string** strings, unsigned short* out, int n)
	 *
	 * @brief	Converts this  to an u 2
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToS2(std::string** strings, short* out, int n)
	 *
	 * @brief	Converts this  to the s 2
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToS4(std::string** strings, int* out, int n)
	 *
	 * @brief	Converts this  to the s 4
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToU4(std::string** strings, unsigned int* out, int n)
	 *
	 * @brief	Converts this  to an u 4
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToS8(std::string** strings, long long* out, int n)
	 *
	 * @brief	Converts this  to the s 8
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToU8(std::string** strings, unsigned long long* out, int n)
	 *
	 * @brief	Converts this  to an u 8
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToF(std::string** strings, float* out, int n)
	 *
	 * @brief	Converts this  to a f
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void ToD(std::string** strings, double* out, int n)
	 *
	 * @brief	Converts this  to a d
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 * @param 		  	n	   	An int to process.
	...
	/**********************************************************************************************//**
	 * @fn	static void StringsToInts(std::vector<std::string>& strings, std::vector<int>& out)
	 *
	 * @brief	Strings to ints
	 *
	 * @param [in,out]	strings	The strings.
	...
	/**********************************************************************************************//**
	 * @fn	static void StringsToLongs(std::vector<std::string>& strings, std::vector<long>& out)
	 *
	 * @brief	Strings to longs
	 *
	 * @param [in,out]	strings	The strings.
	 * @param [in,out]	out	   	The out.
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	static void StringsToULongs(std::vector<std::string>& strings, std::vector<unsigned long>& out)
	 *
	 * @brief	Strings to u longs
	 *
	 * @param [in,out]	strings	The strings.
	 * @param [in,out]	out	   	The out.
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	static void StringsToFloats(std::vector<std::string>& strings, std::vector<float>& out)
	 *
	 * @brief	Strings to floats
	 *
	 * @param [in,out]	strings	The strings.
	 * @param [in,out]	out	   	The out.
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	static void StringsToDoubles(std::vector<std::string>& strings, std::vector<double>& out)
	 *
	 * @brief	Strings to doubles
	 *
	 * @param [in,out]	strings	The strings.
	 * @param [in,out]	out	   	The out.
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	static void StringsToStrings(std::vector<std::string*>* strings, std::vector<std::string>* out)
	 *
	 * @brief	Strings to strings
	 *
	 * @param [in,out]	strings	If non-null, the strings.
	 * @param [in,out]	out	   	If non-null, the out.
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	static void ToLowerASCII(std::string& s)
	 *
	 * @brief	Converts the s to a lower a scii
	 *
	 * @param [in,out]	s	A std::string to process.
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	static char** CommandLineToArgvA(char* CmdLine, int* _argc)
	 *
	 * @brief	Command line to argv a
	 *
	 * @param [in,out]	CmdLine	If non-null, the command line.
	 * @param [in,out]	_argc  	If non-null, the argc.
	 *
	 * @returns	Null if it fails, else a handle to a char.
	 **************************************************************************************************/
	 ...
	 *
	 * @brief	An ez option parser identifier generator.
	 *
	 **************************************************************************************************/
	...
	public:
		...
		/**********************************************************************************************//**
		 * @fn	static ezOptionParserIDGenerator& ezOptionParserIDGenerator::instance()
		 *
		 * @brief	Gets the instance
		 *
		 * @returns	A reference to an ezOptionParserIDGenerator.
		 **************************************************************************************************/

		static ezOptionParserIDGenerator& instance() { static ezOptionParserIDGenerator Generator; return Generator; }

		/**********************************************************************************************//**
		 * @fn	short ezOptionParserIDGenerator::next()
		 *
	...
	private:
		...
		/**********************************************************************************************//**
		 * @fn	ezOptionParserIDGenerator::ezOptionParserIDGenerator()
		 *
...
///< .
	...
	*/
	...
	public:
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(const char* _type, const char* _op = 0, const char* list = 0, bool _insensitive = false);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type			The type.
		 * @param 	_op				(Optional) The operation.
		 * @param 	list			(Optional) The list.
		 * @param 	_insensitive	(Optional) True to insensitive.
		 **************************************************************************************************/

		inline ezOptionValidator(const char* _type, const char* _op = 0, const char* list = 0, bool _insensitive = false);

		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const char* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned char* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const short* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned short* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const int* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned int* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const long long* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned long long* list, int _size = 0);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		 * @param 	_op  	The operation.
		 * @param 	list 	The list.
		 * @param 	_size	(Optional) The size.
		 **************************************************************************************************/

		inline ezOptionValidator(char _type, char _op, const unsigned long long* list, int _size = 0);

		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const float* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const double* list, int _size);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type	The type.
		...
		/**********************************************************************************************//**
		 * @fn	inline ezOptionValidator::ezOptionValidator(char _type, char _op, const char** list, int _size, bool _insensitive);
		 *
		 * @brief	Constructor
		 *
		 * @param 	_type			The type.
		...
		**************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline bool ezOptionValidator::isValid(const std::string* value);
		 *
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionValidator::print();
		 *
		 * @brief	Prints this
		 *
		**************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionValidator::reset();
		 *
		 * @brief	Resets this
		 *
		**************************************************************************************************/
		 ...
		 * @enum	OP
		 *
		 * @brief	Values that represent Operations
		 **************************************************************************************************/
		 ...
		 * @enum	TYPE2
		 *
		 * @brief	Values that represent type 2s
		 **************************************************************************************************/
		...
		**************************************************************************************************/
		...
		union {
			...
			/** @brief	The s 8 */
			long long* s8;
			/** @brief	A float to process */
			float* f;
			/** @brief	A double to process */
			double* d;
			/** @brief	A std::string to process */
			std::string** t;
		};
		...
		/** @brief	The size */
		int size;
		/** @brief	True to insensitive */
		bool insensitive;
	};
	/* ------------------------------------------------------------------- */

	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::~ezOptionValidator()
	 *
	 * @brief	Destructor
	 *
	**************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	void ezOptionValidator::reset()
	 *
	 * @brief	Resets this
	 *
	**************************************************************************************************/
 ...
 * @def	CLEAR(TYPE,P)
 *
 * @brief	A macro that defines clear
 *
 * @param 	TYPE	The type.
...
#define CLEAR(TYPE,P) case TYPE: if (P) delete [] P; P = 0; break;
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const char* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned char* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const short* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned short* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const int* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned int* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const long long* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const unsigned long long* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const float* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const double* list, int _size)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type	The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(char _type, char _op, const char** list, int _size, bool _insensitive)
	 *
	 * @brief	Constructor
	 *
	 * @param 	_type			The type.
	...
	/**********************************************************************************************//**
	 * @fn	ezOptionValidator::ezOptionValidator(const char* _type, const char* _op, const char* _list, bool _insensitive)
	 *
	 * @brief	Option validator.
	 *
	 * @param 	_type			s1, u1, s2, u2, ..., f, d, t 
	 * @param 	_op				Operations: lt, gt, ..., in
	 * @param 	_list			comma-delimited string
	 * @param 	_insensitive	True to insensitive.
	 *
	 * ### returns	Null if it fails, else a pointer to a string.
	 **************************************************************************************************/
 ...
 * @def	FreeStrings
 *
 * @brief	A macro that defines free strings
 *
 **************************************************************************************************/
 ...
 * @def	ToArray(T,P,Y)
 *
 * @brief	A macro that defines to array
 *
 * @param 	T	A void to process.
 * @param 	P	A void to process.
 * @param 	Y	A void to process.
 **************************************************************************************************/
...
#define ToArray(T,P,Y) case T: P = new Y[size]; To##T(strings, P, size); FreeStrings(); break;
	...
	/**********************************************************************************************//**
	 * @fn	void ezOptionValidator::print()
	 *
	 * @brief	Prints this
	 *
	**************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	bool ezOptionValidator::isValid(const std::string* valueAsString)
	 *
	 * @brief	Query if 'valueAsString' is valid
	 *
 ...
 * @def	CHECKRANGE(E,T)
 *
 * @brief	A macro that defines checkrange
 *
 * @param 	E	A void to process.
 * @param 	T	A void to process.
 **************************************************************************************************/
...
/**********************************************************************************************//**
 * @def	VALIDATE(T, U, LIST)
 *
 * @brief	A macro that defines validate
 *
 * @param 	T   	A void to process.
 * @param 	U   	A void to process.
 * @param 	LIST	The list.
 **************************************************************************************************/
  ...
  switch (op) {\
	...
	public:
		...
		**************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::clearArgs();
		 *
		 * @brief	Clears the arguments
		 *
		**************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getInt(int&);
		 *
		 * @brief	Gets an int
		 *
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getLong(long&);
		 *
		 * @brief	Gets a long
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getLongLong(long long&);
		 *
		 * @brief	Gets long
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getULong(unsigned long&);
		 *
		 * @brief	Gets u long
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getULongLong(unsigned long long&);
		 *
		 * @brief	Gets u long
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getFloat(float&);
		 *
		 * @brief	Gets a float
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getDouble(double&);
		 *
		 * @brief	Gets a double
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getString(std::string&);
		 *
		 * @brief	Gets a string
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getInts(std::vector<int>&);
		 *
		 * @brief	Gets the ints
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getLongs(std::vector<long>&);
		 *
		 * @brief	Gets the longs
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getULongs(std::vector<unsigned long>&);
		 *
		 * @brief	Gets u longs
		 *
		 * @param [in,out]	parameter1	The first parameter.
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getFloats(std::vector<float>&);
		 *
		 * @brief	Gets the floats
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getDoubles(std::vector<double>&);
		 *
		 * @brief	Gets the doubles
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getStrings(std::vector<std::string>&);
		 *
		 * @brief	Gets the strings
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getMultiInts(std::vector< std::vector<int> >&);
		 *
		 * @brief	Gets multi ints
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getMultiLongs(std::vector< std::vector<long> >&);
		 *
		 * @brief	Gets multi longs
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getMultiULongs(std::vector< std::vector<unsigned long> >&);
		 *
		 * @brief	Gets multi u longs
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getMultiFloats(std::vector< std::vector<float> >&);
		 *
		 * @brief	Gets multi floats
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getMultiDoubles(std::vector< std::vector<double> >&);
		 *
		 * @brief	Gets multi doubles
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void OptionGroup::getMultiStrings(std::vector< std::vector<std::string> >&);
		 *
		 * @brief	Gets multi strings
		 *
		 * @param [in,out]	parameter1	The first parameter.
		 **************************************************************************************************/
		...
		/** @brief	Zero-based index of the parse */
		std::vector<int> parseIndex;
	};
	/* ################################################################### */

	/**********************************************************************************************//**
	 * @fn	void OptionGroup::clearArgs()
	 *
	 * @brief	Clears the arguments
	 *
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getInt(int& out)
	 *
	 * @brief	Gets an int
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getLong(long& out)
	 *
	 * @brief	Gets a long
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getLongLong(long long& out)
	 *
	 * @brief	Gets long
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getULong(unsigned long& out)
	 *
	 * @brief	Gets u long
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getULongLong(unsigned long long& out)
	 *
	 * @brief	Gets u long
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getFloat(float& out)
	 *
	 * @brief	Gets a float
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getDouble(double& out)
	 *
	 * @brief	Gets a double
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getString(std::string& out)
	 *
	 * @brief	Gets a string
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getInts(std::vector<int>& out)
	 *
	 * @brief	Gets the ints
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getLongs(std::vector<long>& out)
	 *
	 * @brief	Gets the longs
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getULongs(std::vector<unsigned long>& out)
	 *
	 * @brief	Gets u longs
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getFloats(std::vector<float>& out)
	 *
	 * @brief	Gets the floats
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getDoubles(std::vector<double>& out)
	 *
	 * @brief	Gets the doubles
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getStrings(std::vector<std::string>& out)
	 *
	 * @brief	Gets the strings
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getMultiInts(std::vector< std::vector<int> >& out)
	 *
	 * @brief	Gets multi ints
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getMultiLongs(std::vector< std::vector<long> >& out)
	 *
	 * @brief	Gets multi longs
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getMultiULongs(std::vector< std::vector<unsigned long> >& out)
	 *
	 * @brief	Gets multi u longs
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getMultiFloats(std::vector< std::vector<float> >& out)
	 *
	 * @brief	Gets multi floats
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getMultiDoubles(std::vector< std::vector<double> >& out)
	 *
	 * @brief	Gets multi doubles
	 *
	 * @param [in,out]	out	The out.
	...
	/**********************************************************************************************//**
	 * @fn	void OptionGroup::getMultiStrings(std::vector< std::vector<std::string> >& out)
	 *
	 * @brief	Gets multi strings
	 *
	 * @param [in,out]	out	The out.
	 ...
	 *
	 * @brief	Defines an alias representing the validator map
	 **************************************************************************************************/
	...
	public:
		 ...
		 * @enum	Layout
		 *
		 * @brief	Values that represent layouts
		 **************************************************************************************************/

		enum Layout { ALIGN, INTERLEAVE, STAGGER };

		/**********************************************************************************************//**
		 * @fn	inline ezOptionParser::~ezOptionParser();
		 *
		 * @brief	Destructor
		 *
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, ezOptionValidator* validator = 0);
		 *
		 * @brief	Adds defaults
		 *
		 * @param 		  	defaults  	The defaults.
		 * @param 		  	required  	True if required.
		 * @param 		  	expectArgs	The expect arguments.
		 * @param 		  	delim	  	The delimiter.
		 * @param 		  	help	  	The help.
		 * @param 		  	flag1	  	The first flag.
		 * @param [in,out]	validator 	(Optional) If non-null, the validator.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, const char* flag2, ezOptionValidator* validator = 0);
		 *
		 * @brief	Adds defaults
		 *
		 * @param 		  	defaults  	The defaults.
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, const char* flag2, const char* flag3, ezOptionValidator* validator = 0);
		 *
		 * @brief	Adds defaults
		 *
		 * @param 		  	defaults  	The defaults.
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, const char* flag2, const char* flag3, const char* flag4, ezOptionValidator* validator = 0);
		 *
		 * @brief	Adds defaults
		 *
		 * @param 		  	defaults  	The defaults.
		...
		/**********************************************************************************************//**
		 * @fn	inline bool ezOptionParser::exportFile(const char* filename, bool all = false);
		 *
		 * @brief	Export file
		 *
		 * @param 	filename	Filename of the file.
		 * @param 	all			(Optional) True to all.
		 *
		 * @returns	True if it succeeds, false if it fails.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline OptionGroup* ezOptionParser::get(const char* name);
		 *
		 * @brief	Gets an option group* using the given name
		 *
		 * @param 	name	The name to get.
		 *
		 * @returns	Null if it fails, else a pointer to an OptionGroup.
		 **************************************************************************************************/

		inline OptionGroup* get(const char* name);

		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::getUsage(std::string& usage, int width = 80, Layout layout = ALIGN);
		 *
		 * @brief	Gets an usage
		 *
		 * @param [in,out]	usage 	The usage.
		 * @param 		  	width 	(Optional) The width.
		 * @param 		  	layout	(Optional) The layout.
		 **************************************************************************************************/

		inline void getUsage(std::string& usage, int width = 80, Layout layout = ALIGN);

		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::getUsageDescriptions(std::string& usage, int width = 80, Layout layout = STAGGER);
		 *
		 * @brief	Gets usage descriptions
		 *
		 * @param [in,out]	usage 	The usage.
		 * @param 		  	width 	(Optional) The width.
		 * @param 		  	layout	(Optional) The layout.
		...
		/**********************************************************************************************//**
		 * @fn	inline bool ezOptionParser::gotExpected(std::vector<std::string>& badOptions);
		 *
		 * @brief	Got expected
		 *
		 * @param [in,out]	badOptions	Options for controlling the bad.
		 *
		 * @returns	True if it succeeds, false if it fails.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline bool ezOptionParser::gotRequired(std::vector<std::string>& badOptions);
		 *
		 * @brief	Got required
		 *
		 * @param [in,out]	badOptions	Options for controlling the bad.
		...
		/**********************************************************************************************//**
		 * @fn	inline bool ezOptionParser::gotValid(std::vector<std::string>& badOptions, std::vector<std::string>& badArgs);
		 *
		 * @brief	Got valid
		 *
		 * @param [in,out]	badOptions	Options for controlling the bad.
		 * @param [in,out]	badArgs   	The bad arguments.
		 *
		 * @returns	True if it succeeds, false if it fails.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline bool ezOptionParser::importFile(const char* filename, char comment = '#');
		 *
		 * @brief	Import file
		 *
		 * @param 	filename	Filename of the file.
		 * @param 	comment 	(Optional) The comment.
		 *
		 * @returns	True if it succeeds, false if it fails.
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline int ezOptionParser::isSet(const char* name);
		 *
		 * @brief	Is set
		 *
		 * @param 	name	The command-line argument.
		 *
		 * @returns	True if argument is set, false otherwise.
		 **************************************************************************************************/

		inline bool isSet(const char* name);

		/**********************************************************************************************//**
		 * @fn	inline int ezOptionParser::isSet(std::string& name);
		 *
		 * @brief	Is set
		 *
		 * @param	name	The command-line argument.
		...
		inline bool isSet(std::string& name);

		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::parse(int argc, const char* argv[]);
		 *
		 * @brief	Parses
		 *
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::prettyPrint(std::string& out);
		 *
		 * @brief	Pretty print
		 *
		 * @param [in,out]	out	The out.
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::reset();
		 *
		 * @brief	Resets this
		 *
		 **************************************************************************************************/
		...
		/**********************************************************************************************//**
		 * @fn	inline void ezOptionParser::resetArgs();
		 *
		 * @brief	Resets the arguments
		 *
		 **************************************************************************************************/
		...
		/** @brief	List of identifiers for the option groups */
		...
		/** @brief	The group validators */
		std::map< int, int > groupValidators;
	};
	/* ################################################################### */

	/**********************************************************************************************//**
	 * @fn	ezOptionParser::~ezOptionParser()
	 *
	 * @brief	Destructor
	 *
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	void ezOptionParser::resetArgs()
	 *
	 * @brief	Resets the arguments
	 *
	 **************************************************************************************************/
	...
	/**********************************************************************************************//**
	 * @fn	void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, ezOptionValidator* validator)
	 *
	 * @brief	Adds defaults
	 *
	 * @param 		  	defaults  	The defaults.
	...
	/**********************************************************************************************//**
	 * @fn	void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, const char* flag2, ezOptionValidator* validator)
	 *
	 * @brief	Adds defaults
	 *
	 * @param 		  	defaults  	The defaults.
	...
	/**********************************************************************************************//**
	 * @fn	void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, const char* flag2, const char* flag3, ezOptionValidator* validator)
	 *
	 * @brief	Adds defaults
	 *
	 * @param 		  	defaults  	The defaults.
	...
	/**********************************************************************************************//**
	 * @fn	void ezOptionParser::add(const char* defaults, bool required, int expectArgs, char delim, const char* help, const char* flag1, const char* flag2, const char* flag3, const char* flag4, ezOptionValidator* validator)
	 *
	 * @brief	Adds defaults
	 *
	 * @param 		  	defaults  	The defaults.
	...
	/**********************************************************************************************//**
	 * @fn	bool ezOptionParser::exportFile(const char* filename, bool all)
	 *
	 * @brief	Export file
	 *
	 * @param 	filename	Filename of the file.
	...
	/**********************************************************************************************//**
	 * @fn	bool ezOptionParser::importFile(const char* filename, char comment)
	 *
	 * @brief	Import file
	 *
	 * @param 	filename	Filename of the file.
	...
	/* ################################################################### */
	bool ezOptionParser::isSet(const char* name) {
	...
	/* ################################################################### */
	bool ezOptionParser::isSet(std::string& name) {
